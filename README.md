...
* **Version Information**
  * 0.1
* **Ontology RDF**
  * RDF ([https://github.com/RUB-Informatik-im-Bauwesen/srt/blob/main/Ontology_for_Spatial_Reasoning_in_Tunnel_Projects_(srt).ttl](turtle))
### Description
...
[Relation Container](#RelationContainer),
...
Restrictions |[rdfs:label](http://www.w3.org/2000/01/rdf-schema#label) **min** 1<br />[srt:environmentVersion](http://w3id.org/srt#environmentVersion) (op) **exactly** 1<br />[srt:projection](http://w3id.org/srt#projection) (op) **exactly** 1<br />[srt:user](http://w3id.org/srt#user) (op) **exactly** 1<br />[srt:title](http://w3id.org/srt#title) (op) **exactly** 1<br />[srt:environment](http://w3id.org/srt#environment) (op) **exactly** 1<br />[srt:globalReference](http://w3id.org/srt#globalReference) (op) **exactly** 1<br />
In domain of |[srt:environmentVersion](http://w3id.org/srt#environmentVersion) (op)<br />[srt:projection](http://w3id.org/srt#projection) (op)<br />[srt:environment](http://w3id.org/srt#environment) (op)<br />[srt:title](http://w3id.org/srt#title) (op)<br />[srt:user](http://w3id.org/srt#user) (op)<br />[srt:globalReference](http://w3id.org/srt#globalReference) (op)<br />
...
Restrictions |[srt:identifier](http://w3id.org/srt#identifier) (dp) **exactly** 1<br />[srt:hasObject](http://w3id.org/srt#hasObject) (op) **min** 0<br />[srt:hasMeta](http://w3id.org/srt#hasMeta) (op) **exactly** 1<br />[rdfs:label](http://www.w3.org/2000/01/rdf-schema#label) **min** 1<br />
In domain of |[srt:hasObject](http://w3id.org/srt#hasObject) (op)<br />[srt:hasMeta](http://w3id.org/srt#hasMeta) (op)<br />[srt:identifier](http://w3id.org/srt#identifier) (dp)<br />
### Spatial Object
Property | Value
--- | ---
...
Restrictions |[geo:asWKT](http://www.opengis.net/ont/geosparql#asWKT) **exactly** 1<br />[rdfs:label](http://www.w3.org/2000/01/rdf-schema#label) **min** 1<br />[srt:sourceRelation](http://w3id.org/srt#sourceRelation) (op) **min** 0<br />[srt:sourceItentifier](http://w3id.org/srt#sourceItentifier) (op) **exactly** 1<br />[srt:dataType](http://w3id.org/srt#dataType) (dp) **exactly** 1<br />[srt:hasWKTType](http://w3id.org/srt#hasWKTType) (op) **exactly** 1<br />
In domain of |[srt:dataType](http://w3id.org/srt#dataType) (dp)<br />[srt:sourceRelation](http://w3id.org/srt#sourceRelation) (op)<br />[srt:sourceItentifier](http://w3id.org/srt#sourceItentifier) (op)<br />[srt:hasWKTType](http://w3id.org/srt#hasWKTType) (op)<br />
In range of |[srt:hasObject](http://w3id.org/srt#hasObject) (op)<br />

## Object Properties
[environment](#environment),
[environment version](#environmentversion),
[Global Reference Point](#GlobalReferencePoint),
[metadata](#metadata),
[object](#object),
[has WKT Type](#hasWKTType),
[Projection Information](#ProjectionInformation),
[source object identifier](#sourceobjectidentifier),
[source object relation](#sourceobjectrelation),
[title](#title),
[user](#user),
[](environment)
### environment
